...
public class ItemMap extends ItemMapBase
{
    ...
    public MapData getMapData(ItemStack par1ItemStack, World par2World)
    {
        ...
        if (var4 == null)
        {
            ...
            String var5 = "map_" + par1ItemStack.getItemDamage();
            var4 = new MapData(var5);
            ...
            var4.markDirty();
            par2World.setItemData(var5, var4);
        }
                ...
                if ((var12 & 15) == (par3MapData.randomEffect & 15))
                {
                    ...
                    for (int var17 = var10 - var11 - 1; var17 < var10 + var11; ++var17)
                    {
                        if (var12 >= 0 && var17 >= -1 && var12 < var4 && var17 < var5)
                        {
                                    ...
                                    for (var34 = 0; var34 < var6; ++var34)
                                    {
                                        ...
                                        if (var35 > 1)
                                        {
                                            ...
                                            if (var35 > 0 && var36 != 0 && Block.blocksList[var36].blockMaterial.isLiquid())
                                            {
                                                ...
                                                do
                                                {
                                                    var42 = var27.getBlockID(var33 + var28, var38--, var34 + var29);
                                                    ++var30;
                                                }
                                                while (var38 > 0 && var42 != 0 && Block.blocksList[var42].blockMaterial.isLiquid());
                                            }
                                        }
                            ...
                            double var44 = (var31 - var15) * 4.0D / (double)(var6 + 4) + ((double)(var12 + var17 & 1) - 0.5D) * 0.4D;
                            byte var43 = 1;
                            ...
                            if (var34 > 0)
                            {
                                MapColor var47 = Block.blocksList[var34].blockMaterial.materialMapColor;

                                if (var47 == MapColor.waterColor)
                                {
                                    double var40 = (double)var30 * 0.1D + (double)(var12 + var17 & 1) * 0.2D;
                                    var43 = 1;
                            ...
                            {
                                byte var46 = par3MapData.colors[var12 + var17 * var4];
                                byte var45 = (byte)(var38 * 4 + var43);
                                ...
                                if (var46 != var45)
                                {
                                    ...
                                    par3MapData.colors[var12 + var17 * var4] = var45;
                                }
                            }
                        }
                    }
    ...
    public void onCreated(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        {
            par1ItemStack.setItemDamage(par2World.getUniqueDataId("map"));
            var5 = "map_" + par1ItemStack.getItemDamage();
            var4 = new MapData(var5);

            if (mod_HangableMaps.shouldCenterMapsOnPlayer)
            {
                var4.xCenter = MathHelper.floor_double(par3EntityPlayer.posX);
                var4.zCenter = MathHelper.floor_double(par3EntityPlayer.posZ);
            }
            else
            {
                double var6 = par3EntityPlayer.posX / 1024.0D;
                double var8 = par3EntityPlayer.posZ / 1024.0D;
        ...
        {
            var5 = "map_" + par1ItemStack.getItemDamage();
            var4 = this.getMapData(par1ItemStack, par2World);
        }
    ...
    {
        MapData var3 = this.getMapData(var1, var2);

        if (var3.playersArrayList.size() >= 1)
        {
            MapInfo var4 = (MapInfo)var3.playersArrayList.get(0);
            ...
            if (var4 != null)
            {
                ...
                return new Packet131MapData((short)Item.map.shiftedIndex, (short)var1.getItemDamage(), var5);
            }
        }
    ...
    public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7)
    {
        ...
        {
            var10 += var12;
            var8 = MathHelper.floor_double((double)(var2.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
            var13 = 1;
        }
        ...
        else
        {
            ...
            if (!var3.isRemote)
            {
                ...
                if (var14.onValidSurface())
                {
                    ...
                    EntityHangableMap var16 = new EntityHangableMap(var3, var9 + 0.5F, var10 + 0.5F, var11 + 0.5F, var8, var1.getItemDamage(), var15, var13);
                    var16.setOwner(var2);
                    ...
                    if (var1.stackSize > 0)
                    {
                        var2.inventory.addItemStackToInventory(var1);
                    }
